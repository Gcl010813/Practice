...
public class OwnerAddServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Owner owner=new Owner(ownerName,ownPhone,comAddress,houseNumber,peopleCount,isSafe,isCheck,houseCount,sort,notes,/*创建时间*/new Date(),/*更新时间*/new Date());
        if(new OwnerServiceImpl().addOwner(owner)){
